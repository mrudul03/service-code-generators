...
public class PropertiesTemplate {
	...
	private Map<String, PropertiesTemplate> getModelBinding() {
		Map<String, PropertiesTemplate> bindings = new HashMap<>();
	...
	public void generateCode(final Template template) {
		try {
			...
			Map<String, PropertiesTemplate> bindings = this.getModelBinding();
