...
public class MysqlScriptGenerator implements ScriptGenerator{
	...
	public MysqlScriptGenerator(ColumnField field) {
		this.field = field;
	}
	...
	public String generateColumnScript() {
		...
		if (field.isPrimaryKey()) {
			...
			else if (field.getDatatypeClassName().equals(Constants.INTEGER) ||
					field.getDatatypeClassName().equals(Constants.LONG)) {
