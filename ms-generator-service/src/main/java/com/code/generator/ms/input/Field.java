...
public class Field {
	...
	//private static final String DATATYPE_INVALID = " field should bot be have a valid datatype.";
...
//		field.setDatatypeClass();
//		
//		System.out.println("this.datatypeClass:"+field.getDatatypeClass().getSimpleName());
//	}
}
